...
// Чистый, почти белый фон (ощущение стерильности)
...
// Серый для вспомогательной информации
val SecTx = Color(0xFF64748B)

// Акцентный темный (например, для названия лекарств)
val FavTx = Color(0xFF1E293B)
